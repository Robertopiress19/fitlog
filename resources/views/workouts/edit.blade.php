...
@section('content')
    <a href="{{ route('workouts.show', $workout) }}" class="mb-4 inline-block text-sm text-slate-500 hover:text-brand-600 dark:text-slate-400">&larr; Voltar</a>
    <h1 class="mb-6 text-2xl font-bold">Editar treino</h1>
